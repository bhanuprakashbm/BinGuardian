                    ...
                    <div className="general-guide">
                        ...
                        <div className="recycling-process">
                            ...
                            <div className="process-steps">
                                ...
                                <div className={`process-step ${expandedStep === 'sorting' ? 'expanded' : ''}`} onClick={() => toggleStep('sorting')}>
                                    ...
                                    {expandedStep === 'sorting' && (
                                        <div className="step-details">
                                            <h5><TranslatableText>Sorting Process</TranslatableText></h5>
                                            <p>
                                                <TranslatableText>
                                                    The sorting phase of recycling is a sophisticated process that combines advanced technology with human expertise to separate collected materials into pure streams. When recyclables arrive at Material Recovery Facilities (MRFs), they first undergo pre-sorting where workers remove contaminants and non-recyclable items. Then materials move through a series of mechanical systems: trommel screens rotate to separate items by size, air classifiers use controlled airflow to separate lighter materials like paper from heavier ones, magnetic separators pull out ferrous metals, and eddy current separators repel non-ferrous metals like aluminum. Optical sorting technology employs infrared sensors to identify different plastic types by their unique light reflection patterns. Glass is typically sorted by color using optical sensors or manual inspection. Quality control stations staffed by workers ensure proper sorting before materials are compressed into bales for transport to recycling manufacturers. The precision of this sorting process directly impacts the quality and value of recycled materials, with cleaner, well-sorted streams commanding higher prices and resulting in higher-quality recycled products.
                                                </TranslatableText>
                                            </p>
                                            <SpeakButton text="The sorting phase of recycling is a sophisticated process that combines advanced technology with human expertise to separate collected materials into pure streams. When recyclables arrive at Material Recovery Facilities (MRFs), they first undergo pre-sorting where workers remove contaminants and non-recyclable items. Then materials move through a series of mechanical systems: trommel screens rotate to separate items by size, air classifiers use controlled airflow to separate lighter materials like paper from heavier ones, magnetic separators pull out ferrous metals, and eddy current separators repel non-ferrous metals like aluminum. Optical sorting technology employs infrared sensors to identify different plastic types by their unique light reflection patterns. Glass is typically sorted by color using optical sensors or manual inspection. Quality control stations staffed by workers ensure proper sorting before materials are compressed into bales for transport to recycling manufacturers. The precision of this sorting process directly impacts the quality and value of recycled materials, with cleaner, well-sorted streams commanding higher prices and resulting in higher-quality recycled products." />
                                        </div>
                                    )}
                                </div>

                                <div className={`process-step ${expandedStep === 'processing' ? 'expanded' : ''}`} onClick={() => toggleStep('processing')}>
                                    ...
                                    {expandedStep === 'processing' && (
                                        <div className="step-details">
                                            <h5><TranslatableText>Processing Methods</TranslatableText></h5>
                                            <p>
                                                <TranslatableText>
                                                    Material processing transforms sorted recyclables into usable manufacturing feedstock through specialized treatment for each material type. Paper undergoes pulping where it's mixed with water and chemicals to break down into fibers, removing inks and contaminants before being screened, cleaned, and dried into new paper pulp. Plastics are thoroughly washed, then granulated or shredded into small flakes, which undergo a flotation process to separate different plastic types based on density. These flakes are then dried, melted, and formed into pellets ready for manufacturing. Metal processing includes shredding, followed by melting in large furnaces where impurities rise to the surface and are removed as slag. The molten metal is then cast into ingots or sheets. Glass is crushed into cullet (small fragments), cleaned to remove contaminants, sorted by color, and melted at high temperatures to form new glass products. Each material undergoes strict quality control testing throughout processing to ensure the resulting raw materials meet industry specifications. Advanced technologies like optical sorting and density separation continue to improve the efficiency and purity of processed materials, allowing for higher recycled content in manufacturing while reducing energy consumption compared to processing virgin materials.
                                                </TranslatableText>
                                            </p>
                                            <SpeakButton text="Material processing transforms sorted recyclables into usable manufacturing feedstock through specialized treatment for each material type. Paper undergoes pulping where it's mixed with water and chemicals to break down into fibers, removing inks and contaminants before being screened, cleaned, and dried into new paper pulp. Plastics are thoroughly washed, then granulated or shredded into small flakes, which undergo a flotation process to separate different plastic types based on density. These flakes are then dried, melted, and formed into pellets ready for manufacturing. Metal processing includes shredding, followed by melting in large furnaces where impurities rise to the surface and are removed as slag. The molten metal is then cast into ingots or sheets. Glass is crushed into cullet (small fragments), cleaned to remove contaminants, sorted by color, and melted at high temperatures to form new glass products. Each material undergoes strict quality control testing throughout processing to ensure the resulting raw materials meet industry specifications. Advanced technologies like optical sorting and density separation continue to improve the efficiency and purity of processed materials, allowing for higher recycled content in manufacturing while reducing energy consumption compared to processing virgin materials." />
                                        </div>
                                    )}
                                </div>

                                <div className={`process-step ${expandedStep === 'manufacturing' ? 'expanded' : ''}`} onClick={() => toggleStep('manufacturing')}>
                                    ...
                                    {expandedStep === 'manufacturing' && (
                                        <div className="step-details">
                                            <h5><TranslatableText>Manufacturing with Recycled Materials</TranslatableText></h5>
                                            <p>
                                                <TranslatableText>
                                                    The manufacturing stage represents the final transformation in the recycling loop, where processed materials become new consumer products. Recycled paper pulp is fed into papermaking machines that form, press, dry, and roll it into new paper products—from office paper and cardboard to tissue and packaging materials. Recycled plastic pellets are loaded into extruders or injection molding machines that melt and form them into new items ranging from bottles and containers to outdoor furniture, clothing fibers, and construction materials. Manufacturers often blend recycled plastics with virgin materials to achieve specific performance characteristics. Recycled metal ingots are remelted and formed into sheets, rods, or specific shapes through casting, extrusion, or rolling processes to create new metal products. Glass cullet is mixed with raw materials and melted in furnaces at temperatures exceeding 1500°C, then molded or blown into new containers, construction materials, or decorative items. Many companies now emphasize their use of recycled content as both an environmental selling point and cost-saving measure. The integration of recycled materials into manufacturing processes typically requires less energy than using virgin resources, with aluminum recycling saving up to 95% of the energy needed for primary production. This manufacturing stage completes the circular economy model by transforming what was once considered waste into valuable resources that reenter the marketplace as new products.
                                                </TranslatableText>
                                            </p>
                                            <SpeakButton text="The manufacturing stage represents the final transformation in the recycling loop, where processed materials become new consumer products. Recycled paper pulp is fed into papermaking machines that form, press, dry, and roll it into new paper products—from office paper and cardboard to tissue and packaging materials. Recycled plastic pellets are loaded into extruders or injection molding machines that melt and form them into new items ranging from bottles and containers to outdoor furniture, clothing fibers, and construction materials. Manufacturers often blend recycled plastics with virgin materials to achieve specific performance characteristics. Recycled metal ingots are remelted and formed into sheets, rods, or specific shapes through casting, extrusion, or rolling processes to create new metal products. Glass cullet is mixed with raw materials and melted in furnaces at temperatures exceeding 1500°C, then molded or blown into new containers, construction materials, or decorative items. Many companies now emphasize their use of recycled content as both an environmental selling point and cost-saving measure. The integration of recycled materials into manufacturing processes typically requires less energy than using virgin resources, with aluminum recycling saving up to 95% of the energy needed for primary production. This manufacturing stage completes the circular economy model by transforming what was once considered waste into valuable resources that reenter the marketplace as new products." />
                                        </div>
                                    )}
                                </div>
                            </div>
